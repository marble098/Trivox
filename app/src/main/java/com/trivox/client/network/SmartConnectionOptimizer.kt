    ...
    fun verificationPlan(
        ...
        val base = if (!settings.smartConnectionOptimizer) {
            ...
            VerificationPlan(
                ...
                initialDelayMs = when {
                    wireGuard && adaptive -> 350
                    wireGuard -> 850
                    mode == ConnectionMode.VPN && adaptive -> 90
                    mode == ConnectionMode.VPN -> 260
                    adaptive -> 40
                    else -> 120
                },
            ...
            when {
                ...
                network in setOf(
                    ...
                    initialDelayMs =
                        if (mode == ConnectionMode.VPN) 180 else 80,
                ...
                security in setOf("tls", "reality") ->
                    VerificationPlan(
                        ...
                        initialDelayMs =
                            if (mode == ConnectionMode.VPN) 135 else 60,
                    ...
                    initialDelayMs =
                        if (mode == ConnectionMode.VPN) 120 else 50,
