...
class SubscriptionManagementActivity : ThemedActivity() {
    ...
    override fun onCreate(
        ...
        val composeHost = LegacyLayoutBridge.install(this, "activity_subscriptions")
        composeHost.compose.showLegacyMirror(this, composeHost.legacy, getString(R.string.manage_subscriptions))
    ...
    private fun render() {
        ...
        sources.forEach { source ->
            val row =
                LegacyLayoutBridge.row_subscription(this)
    ...
    private fun showEditor(
        ...
        val view =
            LegacyLayoutBridge.dialog_subscription(this)
        val nameInput =
