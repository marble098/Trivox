...
class ConfigEditorActivity : ThemedActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val composeHost = LegacyLayoutBridge.install(this, "activity_config_editor")
        composeHost.compose.showLegacyMirror(this, composeHost.legacy, getString(R.string.edit_config))
