...
class ProxyChainActivity : ThemedActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val composeHost = LegacyLayoutBridge.install(this, "activity_proxy_chain")
        composeHost.compose.showLegacyMirror(this, composeHost.legacy, getString(R.string.add_proxy_chain))
