...
class AdvancedManualConfigActivity : ThemedActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val composeHost = LegacyLayoutBridge.install(this, "activity_advanced_manual_config")
        composeHost.compose.showLegacyMirror(this, composeHost.legacy, getString(R.string.add_manual_config))
