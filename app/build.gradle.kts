...
val signingProps = Properties().apply {
    if (signingPropsFile.isFile) signingPropsFile.inputStream().use(::load)
}
...
android {
    ...
    buildTypes {
        ...
        release {
            ...
            signingConfig = if (signingPropsFile.isFile) signingConfigs.getByName("release") else signingConfigs.getByName("debug")
...
dependencies {
    ...
    if (file("libs/libXray.aar").isFile) implementation(files("libs/libXray.aar"))
